...
<body>
	<div id="root">
		...
		<section id="container">
			...
			<div class="map_wrap">
				<div id="map"
					style="width: 60%; height: 100%; position: relative; overflow: hidden; margin-left: 25%;"></div>
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ed19113fd6206316da167ab101cd3b68&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
